    ...
    render() {
        return (
          ...
          <View style={styles.footer}>
            <TouchableOpacity onPress={Login_Submit} style={styles.button}>
              <Text style={styles.buttonText}>로그인</Text>
            </TouchableOpacity>
            <View style={{textAlign: 'center', flexDirection: 'row', paddingTop: 10}}>
              <Text style={{color: 'black', paddingRight: 10}}>비밀번호 찾기</Text><Text>/</Text><Text style={{color: 'black', paddingLeft: 10}}>회원가입</Text>
            </View>
          </View>
        </View>
      </View>
